    ...
    <section id="services" className="bg-white">
      <div className="mx-auto max-w-7xl px-5 py-20 sm:py-24">
          ...
          {t.valueProp.cards.map((card, i) => (
            ...
            >
              ...
              <div className="relative">
                <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-cta-gradient text-white shadow-soft transition group-hover:scale-105">
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-2">
          <Reveal as="article" variant="left" className="rounded-card border border-lavender-200 bg-paper-tint p-7 shadow-soft">
          ...
          <Reveal as="article" variant="right" delay={150} className="rounded-card border border-lavender-200 bg-paper-tint p-7 shadow-soft">
            <div className="flex items-center gap-3">
